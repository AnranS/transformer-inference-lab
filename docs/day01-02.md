...
| ✅   | 任务 2：Tokenizer 实验        | [`../notebooks/day01_tokenizer_playground.ipynb`](../notebooks/day01_tokenizer_playground.ipynb) |
...
在 `notebooks/day01_tokenizer_playground.ipynb` 中加载两个 tokenizer：
