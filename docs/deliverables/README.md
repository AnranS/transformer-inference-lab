...
这里存放跨多个学习单元的阶段总结。它们不是当天的任务清单，而是每个门禁完成后的可分享成果。
...
6. `06-gqa-and-kv-cache-memory.md`（Day 40）
7. `07-inference-performance.md`（Day 40）
8. `08-next-steps.md`（Day 40）

尚未学习到的交付物只在这里列出名称，不创建空文档。
